...
public class ArticlesMenu {
    ...
    /**
     * a function that connects to the DB articles menu. Scanner takes in user input and and selects a case based off the input recieved. The case will then perform an action such as selecting another menu or table and then prompting the user for more input
     * 
     * @return articlesMenu lists all the menu options for articles to choose and links to those individual menus
